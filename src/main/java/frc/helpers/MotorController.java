 ...
 * @param controlMode    Specify whether the motor controller is operating in
 *                       Brushed or Brushless mode
 * @param idleMode       Specify whether the motor controller is set to Coast or
 *                       Brake mode
 * @param reverse        Reverses the direction of the motor controller
 * @param positionFactor The ratio of encoder units to desired units (ie. units
 *                       -> in)
 */
...
public class MotorController implements edu.wpi.first.wpilibj.motorcontrol.MotorController {
    ...
    public MotorController(String name, int deviceID, MotorType motorType, boolean inverted, IdleMode idleMode,
        ...
        motor.configure(sparkMaxConfig, SparkBase.ResetMode.kResetSafeParameters,
